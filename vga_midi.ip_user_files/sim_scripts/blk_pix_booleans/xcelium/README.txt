...
#
# Generated by export_simulation on Tue May 30 14:42:16 -0400 2023
#
################################################################################
...
'-reset_run' switch to the './blk_pix_booleans.sh' script.

./blk_pix_booleans.sh -reset_run
...
./blk_pix_booleans.sh -noclean_files

For more information on the script, please type './blk_pix_booleans.sh -help'.
